    ...
    <div id="content">
        ...
        <form method="post" action="index.php"> <!-- Assuming you have a file named "process_order.php" to handle the form submission -->
            ...
            if (mysqli_num_rows($result) > 0) {
                echo "<table border='1'>";
                echo "<tr><th>product_id</th><th>product_name</th><th>price</th><th>description</th><th>quantity_left</th><th>Edit Product</th></tr>";
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    // Add the "Edit" button
                    echo "<td><a href='editProduct.php?product_id=" . $row['product_id'] . "'>Edit</a></td>";
...
<!-- Remove Product form -->
<form method="get" action="removeProduct.php">
